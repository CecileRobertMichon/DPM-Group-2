...
//	private static final SensorPort lightPort = SensorPort.S2;
	...
	/*As mentioned in Bangbang controller java file, motorlow and motor high is not used.*/
	...
	public static void main(String [] args) {
		...
		BangBangController bangbang = new BangBangController(bandCenter, bandWidth);
