...
public class Lab1 {
	...
	// Default values changed for better results
	private static final int bandCenter = 27, bandWidth = 3;
	private static final int motorLow = 3, motorHigh = 300;

	public static void main(String[] args) {
		/*
		 * Wait for startup button press Button.ID_LEFT = BangBang Type
		...
		BangBangController bangbang = new BangBangController(bandCenter,
